  ...
  return (
    <div>
      ...
      <footer className="px-6 md:px-16 py-10 mt-8 flex flex-col md:flex-row justify-between gap-10 text-[#1E1E1E] text-sm">
        {/* Left - Brand */}
        <div>
          <h3 className="text-xl font-bold text-[#275DB0] mb-2">SkillConnect</h3>
          <p className="max-w-xs text-md font-semibold">Get real jobs. Hire skilled<br></br> Artisans. Pay and get paid<br></br> securely.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-28">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="bg-[#275DB033] p-6 rounded-full hover:shadow-md">
                 <img
                  src={twitter}
                  alt="t"
                  className=" text-[#275DB0]"
                />
              </a>
              <a href="#" className="bg-[#275DB033] p-6 rounded-full hover:shadow-md">
                  <img

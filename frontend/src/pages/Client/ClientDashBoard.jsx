      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 m-4">
            {statsData.map(({ title, count, icon, color, link }, index) => (
              <Link to="/post-job" className="block " key={index}>
                <div
                  key={index}
          ...
          <div className="rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {quickActions.map(
                ({ title, subtitle, icon, color, link }, index) => (
                  <Link to={link} className="block" key={index}>
                    <div
                      key={index}
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <ul className="space-y-6 border-b">
              {recentActivities.map(({ text, time, link }, index) => (
                <Link to={text.link} className="block" key={index}>
          ...
          <div className="bg-white min-h-66 rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <ul className="space-y-4 border-b">
              {notifications.map(({ text, detail, time, link }, index) => (
                <Link to={text.link} className="block" key={index}>
                  <li key={index} className="relative">

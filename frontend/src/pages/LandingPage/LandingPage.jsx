...
import StateSelector from "../../components/Locations";
import Footer from "../../components/Footer";

import vec1 from "@/assets/image/vec1.jpeg";
import vec2 from "@/assets/image/vec2.jpeg";
import vec3 from "@/assets/image/vec3.jpeg";
import vec4 from "@/assets/image/vec4.jpeg";
import flag from "@/assets/image/flag.jpeg";
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen scroll-in overflow-x-hidden">
      <HeaderLandingPage />

      <div className="relative min-h-screen flex w-full flex-col justify-center items-center text-center py-12 space-y-8 bg-white animate-fade-up delay-500">
        <h2 className="text-[3rem] sm:text-4xl md:text-5xl font-switzer bg-gradient-to-r from-[#000000] via-[#275DB0] to-[#1E1E1E] bg-clip-text text-transparent text-center leading-snug animate-fade-up delay-500">
